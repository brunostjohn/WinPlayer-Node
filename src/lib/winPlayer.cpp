...
{
	if (this->activePlayer.has_value())
		FireAndForget(this->players[this->activePlayer.value()]->TryPlayAsync());
};

void Player::Pause()
{
	if (this->activePlayer.has_value())
		FireAndForget(this->players[this->activePlayer.value()]->TryPauseAsync());
}

void Player::PlayPause()
{
	if (this->activePlayer.has_value())
		FireAndForget(this->players[this->activePlayer.value()]->TryTogglePlayPauseAsync());
}

void Player::Stop()
{
	if (this->activePlayer.has_value())
		FireAndForget(this->players[this->activePlayer.value()]->TryStopAsync());
}

void Player::Next()
{
	if (this->activePlayer.has_value())
		FireAndForget(this->players[this->activePlayer.value()]->TrySkipNextAsync());
}

void Player::Previous()
{
	if (this->activePlayer.has_value())
		FireAndForget(this->players[this->activePlayer.value()]->TrySkipPreviousAsync());
}
